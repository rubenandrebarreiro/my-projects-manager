...
| 10 | [`Everyone Is a Hero`]() | `A mobile app to offer interactive support and information to families, educators and volunteers of children who suffer of cancer diseases! 🧒 👪 📱` | `Private` | `0.1` | [![current progress of this project](http://progressed.io/bar/60)]() | `Set 2018 - Dec 2018` | `Not defined yet` | ✓ |
| 11 | [`Fire Fighting - Autonomous and Intelligent Agents in the Fight against Forest Fires`](https://github.com/rubenandrebarreiro/fire-fighting-autonomous-intelligent-agents) | `Fighting forest fires with the use of flying and terrestrial autonomous and intelligent vehicles, like aircrafts, drones and fire-trucks with the aid of a headquarter! 🛩️ 🚒 🔥` | `Public` | `1.0` | [![current progress of this project](http://progressed.io/bar/70)](https://github.com/rubenandrebarreiro/fire-fighting-autonomous-intelligent-agents) | `Nov 2018 - Dec 2018` | `Free` | ✓ |
...
| 14 | [`UniMaterials`]() | `Mobile application for sales, exchanges or donations of university material between college students in Portugal and Europe! 📱 👨‍🎓 📚` | `Private` | `0.1` | [![current progress of this project](http://progressed.io/bar/10)]() | `Jan 2019 - Now` | `Not defined yet` | ✓ |
| 15 | [`Resident Evil - Sample Data Analytics`](https://github.com/rubenandrebarreiro/resident-evil-sample-data-analytics) | ` ` | `Public` | `0.1` | [![current progress of this project](http://progressed.io/bar/10)](https://github.com/rubenandrebarreiro/resident-evil-sample-data-analytics) | `Feb 2019 - Now` | `Free` | ✓ |
| 16 | [`Student Calculator`](https://github.com/rubenandrebarreiro/student-calculator) | `A simple and modern calculator with 4 modes: Standard, Scientific, Programmer and Date! 👤 ➕ ➖` | `Public` | `0.1` | [![current progress of this project](http://progressed.io/bar/15)](https://github.com/rubenandrebarreiro/student-calculator) | `Feb 2019 - Now` | `Free` | ✓ |
