...
| 14 | [`Resident Evil - Sample Data Analytics`](https://github.com/rubenandrebarreiro/resident-evil-sample-data-analytics) | `A simple and modern calculator with 4 modes: Standard, Scientific, Programmer and Date! 👤 ➕ ➖` | `Public` | `0.1` | [![current progress of this project](http://progressed.io/bar/10)](https://github.com/rubenandrebarreiro/resident-evil-sample-data-analytics) | `Feb 2019 - Now` | `Free` | ✓ |
