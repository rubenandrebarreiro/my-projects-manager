...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [`Rúben André Barreiro | GitHub's Portfolio/Personal Blog`](https://rubenandrebarreiro.github.io/) | `My personal's web-based GitHub's portfolio/personal blog! 👤 💻 🖱️` | `Public` | `1.0` | [![current progress of this project](http://progressed.io/bar/100)](https://rubenandrebarreiro.github.io/) | `Feb 2018 - Present` | `Free` |
...
| 10 | [`UniMaterials`]() | `Mobile application for sales, exchanges or donations of university material between college students in Portugal and Europe! 📱 👨‍🎓 📚` | `Private` | `0.1` | [![current progress of this project](http://progressed.io/bar/10)]() | `Jan 2019 - Present` | `Not defined yet` |
